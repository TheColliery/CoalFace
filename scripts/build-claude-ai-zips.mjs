...
// the GitHub Release as an asset (board #40, C2-v2 design, ported from
// CoalMine's exemplar -- this room ships one skill, but the loop below
// generalizes to any count without a code change).
//
