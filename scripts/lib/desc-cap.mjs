...
// truncate or reject. Also the shared frontmatter reader for
// scripts/build-claude-ai-zips.mjs (board #40) -- extracted here so both
// consumers read one implementation, never two.
//
